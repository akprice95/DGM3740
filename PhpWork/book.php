...
<div class="bookCruise">
	<form action="" method="GET" enctype="multipart/form-data">
		...
		<select>
			<option value="Pluto">Pluto Belt</option>
			<option value="Ubba">Ubba Station</option>
			<option value="Saturn">Saturn's Ring</option>
			<option value="Tyco">Tyco Station</option>
		</select>
